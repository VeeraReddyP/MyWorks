...
public class XLReader {
	...
	public String getCellData(String sheetName, String colName, int rowNum) {
		try {
			...
			if (cell == null)
				return "";
			//Added to convert numeric to String
	...
	public static void main(String arg[]) throws IOException {
		...
		XLReader datatable = new XLReader(
				System.getProperty("user.dir") + "/src/main/java/com/testing/resources/testData.xlsx");
		//
		System.out.println(datatable.getCellData("DemoData", "User", 2));
